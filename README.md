...
**-fg / --foreground** - allows user to specify the color for the characters used in conversion. Expects 3 intiger values: red, green and blue. Defaults to 255, 255, 255.\
**-gb / --gackground** - allows user to specify the color for the background of the video. Expects 3 intiger values: red, green and blue. Defaults to 0, 0, 0.\
**--fghex** - allows user to specify the color for the characters used in conversion. Expects hex string. Defaults to #FFFFFF.\
**--bghex** - allows user to specify the color for the background of the video. Expects hex string. Defaults to #000000.
